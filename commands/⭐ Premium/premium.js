    ...
    async execute(client, message, args){
        ...
        if(!m) return message.channel.send("❌ `|` Please enter a valid key.")
            ...
            if(args[0]) {
                ...
                if(args[0].includes("A9172TwpLs")) return message.channel.send("`⭐` You have successfully claimed your premium! `⭐`")
                ...
                if(!args[0].includes("A9172TwpLs")) return message.channel.send("❌ `|` Please enter a valid key.")
